...
const Documents = () => {
    ...
    return (
        <div className="max-w-5xl mx-auto pt-28 px-6">
            ...
            <p className="text-slate-500 mb-8">Upload and manage your study materials here.</p>
                    ...
                    <div className="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-3 gap-6">
                        {documents.map((doc) => (
                            <div
                                ...
                                className="bg-white border border-slate-200/70 rounded-xl p-5 flex items-center justify-between gap-4 shadow-sm hover:shadow-md transition-shadow cursor-pointer group"
                            >
